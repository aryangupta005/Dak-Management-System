...
<body class="inbox-bg">
    ...
    <script>
        function showOptions(optionId) {
            ...
            if (selectedOption) {
                selectedOption.style.display = "grid";
            }
        }
    </script>
    ...
    margin: 30px; padding: 10px">
        <input type="radio" id="searchBySubject" value="searchBySubject" onclick="showOptions('search1');" name="searchfilter">
        <label for="searchBySubject">Search by Subject</label>
        <div id="search1" class="suboptions" style="display:none;">
            <p>
                <input id="myInput" type="text" onKeyUp="myFunction()" placeholder="Search .." title="Type">
            </p>
        </div>
        <input type="radio" id="searchByLetterDate" value="searchByLetterDate" onclick="showOptions('search2');" name="searchfilter">
        <label for="searchByLetterDate">Search by Letter Date</label>
        <div id="search2" class="suboptions" style="display:none;">
            <p>
        ...
        <input type="radio" id="searchByLetterNo" value="searchByLetterNo" onclick="showOptions('search3');" name="searchfilter">
        <label for="searchByLetterNo">Search by Letter Number</label>
        <div id="search3" class="suboptions" style="display:none;">
            <p>
                <input id="letterno" type="text" onKeyUp="filterByLetterno" placeholder="Search" name="letterno">
            </p>
        </div>
        <input type="radio" id="searchByDocketDate" value="searchByDocketDate" onclick="showOptions('search4');" name="searchfilter"><label for="searchByDocketDate">Search by Docket date</label>
        <div id="search4" class="suboptions" style="display:none;">
            <p>
                Between <input id="fromdate" type="date" name="fromdate"> and <input id="todate" type="date" name="todate">
            </p>
            <button align="center" style="width: 200px" onKeyUp="filterByDocketDate()">Search</button>
        </div>
        <input type="radio" id="searchByReply" value="searchByReply" onclick="showOptions('search5');" name="searchfilter">
        <label for="searchByReply">Search by reply</label>
        <div id="search5" class="suboptions" style="display:none;">
            <p>
        ...
        <input type="radio" id="searchByReplyType" value="searchByReplyType" onclick="showOptions('search6');" name="searchfilter">
        <label for="searchByReplyType">Search by reply type</label>
        <div id="search6" class="suboptions" style="display:none;">
            <p>
        ...
        <input type="radio" id="searchByLetterMode" value="searchByLetterMode" onclick="showOptions('search7');" name="searchfilter">
        <label for="searchByLetterMode">Search by Letter mode</label>
        <div id="search7" class="suboptions" style="display:none;">
            <p>
        ...
        <input type="radio" id="searchByMeMarkedLetters" value="searchByMeMarkedLetters" onclick="showOptions('search8'); showMeMarkedLetters(<?php echo $_SESSION['username']; ?>);" name="searchfilter">
