...
<script src="includes/filter.js"></script>
 ...
 </head><body class="outbox-bg">
 <?php include 'includes/header.php';
 include 'includes/nav.php'; ?>
<p>&nbsp;</p>
<p align="center" class="font36"><img src="image/outbox2.png" width="80" height="80"> OUTBOX <img
src="image/outbox2.png" width="80" height="80"></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
 <?php
